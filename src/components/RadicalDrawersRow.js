...
const RadicalDrawersRow = () => {
    ...
    return (
        <>
            <DrawerCuboidStatic width={drawerWidth} height={drawerHeight} depth={drawerDepth} cubeColor='white'
                                fontColor='black'>
            ...
            <DrawerCuboidStatisGradient width={drawerWidth} height={drawerHeight} depth={drawerDepth} cubeColor='orange'
                                        fontColor='black'>
