...
const CoSlider = () => {
    return (
        <div className={coSlider} style={Object.assign({backgroundImage: `url(${background})`}, {backgroundSize: `cover`})}>
            ...
            <div className={sliderLeftArrow} ><DrawerCuboidStatic width='4.2vw'><SliderArrowLeft className={arrow}/></DrawerCuboidStatic></div>
            ...
            <div className={sliderRightArrow}><DrawerCuboidStatic width='4.2vw'><SliderArrowRight className={arrow}/></DrawerCuboidStatic></div>
