...
const CoSlider = () => {
    return (
        <div className={coSlider} style={Object.assign({backgroundImage: `url(${background})`}, {backgroundSize: `cover`})}>
            ...
            <div className={sliderLeftArrow} ><DrawerCuboidStatic section='co-section' brand='slider'><SliderArrowLeft className={arrow}/></DrawerCuboidStatic></div>
            ...
            <div className={sliderRightArrow}><DrawerCuboidStatic section='co-section' brand='slider'><SliderArrowRight className={arrow}/></DrawerCuboidStatic></div>
