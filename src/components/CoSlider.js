...
import Index from "./Drawers/DrawerCuboidStatic";
...
const CoSlider = () => {
    return (
        <div className={coSlider} style={Object.assign({backgroundImage: `url(${background})`}, {backgroundSize: `cover`})}>
            ...
            <div className={sliderLeftArrow} ><Index width='4.2vw'><SliderArrowLeft className={arrow}/></Index></div>
            ...
            <div className={sliderRightArrow}><Index width='4.2vw'><SliderArrowRight className={arrow}/></Index></div>
